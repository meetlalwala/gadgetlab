...
<div class="row">
    ...
    <div class="container">
        ...
        <div class="mt-4" style="  position: absolute; left: 90%;"><a href="addcategory.php" class="btn btn-primary">Add Category</a></div>
...
?>
            ...
            <div class="col-3 m-2 ms-2 ">
                <div class="card shadow-lg" style="width: 18rem;">
                    ...
                    <hr style="width: 250px; border:1px solid black" class="ms-3">
                    <div class="card-body">
                      <h5 class="card-title"><?php echo $row['categoryname']?></h5>
                      <p class="card-text"><?php echo $row['cdesc']?></p>
                      <?php  echo '<a href="editcategory.php ?cid='.$row['cid'].'" class="btn  btn-outline-success me-3">Update</a>' ?>
                      <?php  echo '<a href="delcategory.php ?cid='.$row['cid'].'" class="btn  btn-outline-danger me-3">Delete</a>' ?>
                    </div>
                </div>
            </div>
